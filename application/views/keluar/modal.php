				...
				<form action="<?= base_url('Dashboard/ins_keluar') ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<?php if ($this->uri->segment(3) != null) : ?>
							<input type="text" class="form-control" id="jns" name="jns" value="<?= $this->uri->segment(3) ?>" readonly>
						<?php else : ?>
							<input type="text" class="form-control" id="jns" name="jns" list="jns_srtk" placeholder="jenis Surat">
							<datalist id="jns_srtk">
